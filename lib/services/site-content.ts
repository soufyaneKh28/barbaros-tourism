...
export const getResolvedSiteContent = cache(async (locale: Locale): Promise<ResolvedSiteContent> => {
    ...
    return {
        hero: {
            ...
            ctaPrimaryLabel: pick(raw.home_hero.ctaPrimaryLabel, locale, t.hero?.exploreTours || DEFAULT_HOME_HERO.ctaPrimaryLabel),
            ctaPrimaryLink: raw.home_hero.ctaPrimaryLink || DEFAULT_HOME_HERO.ctaPrimaryLink,
            ctaPrimaryEnabled: raw.home_hero.ctaPrimaryEnabled !== false,
            ctaSecondaryLabel: pick(raw.home_hero.ctaSecondaryLabel, locale, t.hero?.medicalTourism || DEFAULT_HOME_HERO.ctaSecondaryLabel),
            ctaSecondaryLink: raw.home_hero.ctaSecondaryLink || DEFAULT_HOME_HERO.ctaSecondaryLink,
            ctaSecondaryEnabled: raw.home_hero.ctaSecondaryEnabled !== false,
        },
