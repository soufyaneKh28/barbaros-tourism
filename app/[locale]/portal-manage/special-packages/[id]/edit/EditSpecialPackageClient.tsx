...
import { updateSpecialPackageAction } from '@/app/actions/specialPackages';
...
export default function EditSpecialPackageClient({ packageData, packageId }: Props) {
    ...
    const [mainImageUrl, setMainImageUrl] = useState(packageData.main_image || '');
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            const result = await updateSpecialPackageAction(packageId, formData);
            ...
            <div className="p-8 max-w-4xl mx-auto">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold font-cabinet text-primary">
                        {t.portalAdmin.specialPackages.editTitle}
                    </h1>
                    <p className="text-gray-600 mt-2">
                        {t.portalAdmin.specialPackages.editSubtitle}
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-8 space-y-6">
                    ...
                    <MultiLangInput
                        ...
                        defaultValue={packageData?.package_name}
                    />
                    ...
                    <MultiLangInput
                        ...
                        defaultValue={packageData?.target_categories}
                    />
                    ...
                    <MultiLangInput
                        ...
                        defaultValue={packageData?.duration_nights}
                    />
                    ...
                    <MultiLangTextarea
                        ...
                        rows={6}
                        defaultValue={packageData?.daily_itinerary}
                    />
                    ...
                    <div>
                        <ImageUpload
                            ...
                            currentImage={packageData?.main_image}
                    ...
                    <div className="flex gap-4 pt-6">
                        ...
                        >
                            {saving ? t.portalAdmin.specialPackages.saving : t.portalAdmin.specialPackages.saveChanges}
                        </button>
                        <button
                            type="button"
                            onClick={() => router.back()}
