...
export default async function AboutUs({
    ...
    const story = generic.about_story;
    const stats = generic.about_stats;
    const whyChoose = generic.about_why_choose;
    ...
    return (
        <div className="bg-white">
            ...
            <section className="py-20 px-6 ">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-4xl font-bold font-cabinet text-center mb-12 text-gray-900">{whyChoose.heading}</h2>

                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            <svg key="trusted" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <svg key="value" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>,
                            <svg key="personalized" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>,
                            <svg key="team" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            const item = whyChoose.items[index] as { title: string; description: string } | undefined;
                            if (!item) return null;
                            return (
