...
const reasons = [
    {
        ...
        description: "All our partner hospitals hold international Joint Commission International accreditation, ensuring the highest standards of care."
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        description: "Save up to 70% compared to Western countries without compromising on quality or safety standards."
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        description: "Our medical professionals have years of international experience and specialized training in their fields."
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        description: "From translation services to accommodation and transfers, we handle all logistics for a seamless experience."
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: "Tourism Combination",
        description: "Combine your treatment with a memorable vacation in one of the world's most beautiful countries."
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        description: "Continued support after your return home with online consultations and follow-up care."
    },
];

export default function MedicalWhyChoose() {
    return (
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="max-w-2xl mx-auto text-gray-600 font-satoshi text-lg leading-relaxed">
                        Türkiye has become a global leader in medical tourism, combining cutting-edge facilities with exceptional service and stunning locations.
                    </p>
                </div>
                ...
                >
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        <div>
                            ...
                            <div className="text-white/90 font-satoshi">JCI Hospitals</div>
                        </div>
                        <div>
                            <div className="text-4xl font-bold font-cabinet text-secondary mb-2">500K+</div>
                            <div className="text-white/90 font-satoshi">Annual Patients</div>
                        </div>
                        <div>
                            <div className="text-4xl font-bold font-cabinet text-secondary mb-2">70%</div>
                            <div className="text-white/90 font-satoshi">Cost Savings</div>
                        </div>
                        <div>
                            <div className="text-4xl font-bold font-cabinet text-secondary mb-2">98%</div>
                            <div className="text-white/90 font-satoshi">Satisfaction Rate</div>
                        </div>
                    </div>
                </motion.div>
            </div>
