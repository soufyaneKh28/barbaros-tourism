...
export default function ContactHero({ locale }: ContactHeroProps) {
    return (
        <section className="relative min-h-[50vh] flex flex-col">
            ...
            {/* Content */}
            <div className="relative z-10 flex-1 flex flex-col justify-center items-center text-center px-6 py-20 mt-20">
                <motion.div
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold font-cabinet text-white mb-6 leading-tight">
                        Let's Start Your <br />
                        <span className="text-secondary">Journey</span>
                    </h1>
                    <p className="text-xl font-satoshi text-white/80 leading-relaxed max-w-2xl mx-auto">
