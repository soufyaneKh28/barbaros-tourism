...
export default function WhatsAppButton() {
  ...
  const positionClass = isArabic ? 'left-10' : 'right-10';
    ...
    >
      ...
      <style jsx>{`
        ...
        .whatsapp-tooltip::after {
          ...
          position: absolute;
          top: 50%;
          ${isArabic ? 'left: -6px;' : 'right: -6px;'}
          transform: translateY(-50%);
          border-width: ${isArabic ? '6px 6px 6px 0' : '6px 0 6px 6px'};
          border-style: solid;
          border-color: ${isArabic ? 'transparent white transparent transparent' : 'transparent transparent transparent white'};
        }
