...
export default function SocialLinks() {
    ...
    const positionClass = isArabic ? 'left-5 md:left-12' : 'right-5 md:right-12';

    // Social media links - update these with actual URLs
    const socialLinks = {
        facebook: 'https://www.facebook.com/barbaros.grp',
        instagram: 'https://www.instagram.com/barbaros.grp/',
    };

    return (
        <div className={`fixed bottom-24 md:bottom-[120px] ${positionClass} flex flex-col gap-4 z-[1001]`}>
            <a
