...
const services = [
    {
        ...
        price: "From €1,500",
        description: "Advanced hair restoration techniques with natural-looking results.",
        icon: (
    ...
    },
    {
        ...
        price: "From €300",
        description: "Transform your smile with state-of-the-art dental care.",
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        price: "From €2,500",
        description: "Expert cosmetic procedures for enhanced confidence.",
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        price: "From €1,200",
        description: "Advanced laser eye treatments for perfect vision.",
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        price: "From €3,500",
        description: "Life-changing weight loss surgery with comprehensive support.",
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        price: "From €4,000",
        description: "Advanced orthopedic treatments for mobility restoration.",
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-[32px] lg:text-[42px] leading-tight font-cabinet font-extrabold text-primary mb-4">
                        Comprehensive Medical <span className="text-secondary">Procedures</span>
                    </h2>
                    <p className="max-w-2xl mx-auto text-gray-600 font-satoshi text-lg leading-relaxed">
                        From cosmetic enhancements to life-changing surgeries, we offer a full range of medical services with world-class expertise.
                    </p>
                </div>
