    ...
    return (
        ...
        >
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
                <h3 className="text-lg font-bold font-cabinet text-primary mb-4">Tags</h3>
                <div className="flex flex-wrap gap-3">
                    {tags.map((tag, index) => (
                        <span
                            key={index}
                            className="px-4 py-2 bg-gray-100 hover:bg-primary hover:text-white transition-colors rounded-full text-sm font-medium font-cabinet cursor-pointer"
                        >
                            #{tag}
                        </span>
                    ))}
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
                <h3 className="text-lg font-bold font-cabinet text-primary mb-4">Share this article</h3>
                <div className="flex gap-3">
                    <button className="w-10 h-10 bg-gray-100 hover:bg-primary hover:text-white transition-colors rounded-full flex items-center justify-center">
